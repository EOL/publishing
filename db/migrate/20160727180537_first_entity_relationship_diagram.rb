class FirstEntityRelationshipDiagram < ActiveRecord::Migration
  def change
    ...
    add_index :media, [:content_id, :content_type],
      name: "content_fk_index"
    ...
    add_index :articles, [:content_id, :content_type],
      name: "content_fk_index"
    ...
    add_index :links, [:content_id, :content_type],
      name: "content_fk_index"
    ...
    add_index :maps, [:content_id, :content_type],
      name: "content_fk_index"
