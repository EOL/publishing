...
%w( search pages terms home_page_feeds home_page_feed_items home_page media traits user/sessions users collections traits/data_viz editor_pages admin/editor_pages admin/editor_page_contents ).each do |controller|
