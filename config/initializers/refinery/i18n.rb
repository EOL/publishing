...
#  could add any language here 
   config.frontend_locales = [:en, :ar, :fr, :pt, :es, :fi, :'pt-BR']

   config.locales = {en: "English", ar: "Arabic", fr: "Français", pt: "Português", es: "Español", mk: "англиски", fi: "suomi", :'pt-BR' => "português do Brasil"}
