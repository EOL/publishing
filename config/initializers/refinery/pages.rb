...
Refinery::Pages.configure do |config|
  ...
  # config.friendly_id_reserved_words = ["index", "new", "session", "login", "logout", "users", "refinery", "admin", "images", "wymiframe", "pages", "auth", "facebook", "callback", "twitter", "yahoo", "password", "edit", "cancel", "confirmation", "collections", "search", "media", "resources", "terms"]
