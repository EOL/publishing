class Resource < ActiveRecord::Base
  ...
  class << self
    ...
    def iucn
      @@iucn ||= Resource.where(name: "IUCN Structured Data").first_or_create do |r|
    ...
    def extinction_status
      @@extinction_status ||= Resource.where(name: "Extinction Status").first_or_create do |r|
    ...
    def paleo_db
      @@paleo_db ||= Resource.where(name: "The Paleobiology Database").first_or_create do |r|
